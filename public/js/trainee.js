...
function renderCertifications(t) {
  ...
  el.innerHTML = t.certifications.map(c => `
    <div style="display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid rgba(255,255,255,0.04);cursor:pointer;" onclick="showToast('Verified Credential: ${c.replace(/'/g, "\\'")}', 'success')">
